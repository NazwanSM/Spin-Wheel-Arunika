    ...
    <div className="relative w-full max-w-[320px] sm:max-w-[400px] md:max-w-[500px] lg:max-w-[550px] aspect-square flex items-center justify-center">
      ...
      <div className="absolute top-[-20px] md:top-[-25px] left-1/2 -translate-x-1/2 z-20">
         ...
         >
            ...
            <polygon points="25,55 5,10 45,10" fill="#D84315" />
            <polygon points="25,48 12,15 38,15" fill="#FF5722" />
            {/* Lingkaran di atas */}
            <circle cx="25" cy="10" r="10" fill="#BF360C" />
            <circle cx="25" cy="10" r="6" fill="#FF5722" />
         </svg>
      </div>
      ...
      <div className="w-full h-full rounded-full p-2 md:p-2 shadow-2xl"
        ...
        >
          {items.length > 0 ? (
            <svg viewBox="-1.02 -1.02 2.04 2.04" className="w-full h-full" style={{ background: '#4E342E' }}>
              {/* Background circle untuk menghilangkan transparansi */}
              <circle cx="0" cy="0" r="1.02" fill="#4E342E" />
            ...
            <div className="w-full h-full rounded-full bg-[#4E342E] flex items-center justify-center text-white">
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-12 h-12 sm:w-14 sm:h-14 md:w-16 md:h-16 rounded-full z-10 flex items-center justify-center"
           style={{
             ...
             boxShadow: '0 4px 15px rgba(0,0,0,0.3), inset 0 2px 4px rgba(255,255,255,0.8)',
